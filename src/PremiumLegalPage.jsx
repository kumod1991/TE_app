...
export default function PremiumLegalPage({ T, onClose, initialTab = "disclaimer" }) {
    ...
    const privacySections = [
        ...
        { title: "4. Third-Party Advertising and Google AdSense Cookies", intro: "TradeEdge uses Google AdSense and third-party advertising partners to serve ads. Please note:", bullets: ["Third-party vendors, including Google, use cookies to serve ads based on a user's prior visits to TradeEdge or other websites on the Internet.", "Google's use of advertising cookies enables it and its partners to serve ads to users based on their visit to our sites and/or other sites on the Internet.", "Users may opt out of personalized advertising by visiting Google Ads Settings (https://www.google.com/settings/ads) or AboutAds (http://www.aboutads.info).", "You can also manage or disable cookies directly in your web browser settings."] },
        { title: "5. Data Use, Security, and Rights", bullets: ["Collected data is used to authenticate accounts, store journal and portfolio data, and provide analytics based on your inputs.", "We use encrypted transport, row-level access controls, and restricted administrative access.", "Users may request access, correction, deletion, export, and withdrawal of consent subject to applicable law.", "Contact support@tradeedge.in for privacy rights requests."], outro: "Except for Google AdSense advertising cookies as specified above, we do not sell, rent, or trade your personal account data with third parties." },
    ];
    const termsSections = [
